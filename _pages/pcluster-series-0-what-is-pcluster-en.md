...
One thing worth noting: FSx Lustre (if you're using shared storage) has to exist before you run this. ParallelCluster doesn't create FSx for you — it attaches to a filesystem ID you provide in the config.
