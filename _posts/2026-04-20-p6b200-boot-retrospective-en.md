...
**[한국어 버전은 여기](/infrastructure/2026-04-20-p6b200-boot-retrospective)**
...
> Kernel-dependent modules (lustre, drivers) are built for a **specific kernel version**.  
> After AMI build, verify with `uname -r` and install all modules against that exact version.
{: .block-tip }
...
# 3. systemd
systemctl enable nvidia-fabricmanager   # NOT masked or disabled
